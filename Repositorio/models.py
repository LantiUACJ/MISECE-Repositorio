...
class P_observacion(models.Model):
    ...
    codigo_sistema = models.CharField(max_length=150)
    codigo_codigo = models.CharField(max_length=50)
    codigo_visual = models.CharField(max_length=150)
    codigo_texto = models.CharField(max_length=150)
    ...
    cantidad_visual = models.CharField(max_length=150)
    cantidad_texto = models.CharField(max_length=150)
